...
class TestInstallmentIntegration(TestCase):
    ...
    def test_add_offer_without_installment_via_web(self):
        ...
        form_data = {
            ...
            # payments_per_year_variant_1 не указываем - должно автоматически стать 1
        }
        ...
        self.assertEqual(offer.installment_variant_1, False)
        self.assertEqual(offer.payments_per_year_variant_1, 1)  # Должно быть автоматически установлено в 1
    ...
    def test_add_offer_with_installment_via_web(self):
        ...
        form_data = {
            ...
            'payments_per_year_variant_1': 4,  # Квартальные платежи
        }
        ...
        # Проверяем, что предложение создалось
        offer = InsuranceOffer.objects.get(company_name='Согаз')
        self.assertEqual(offer.insurance_year, 1)
        self.assertEqual(offer.installment_variant_1, True)
        self.assertEqual(offer.payments_per_year_variant_1, 4)  # Должно остаться 4
    ...
    def test_edit_offer_without_installment_via_web(self):
        ...
        self.assertEqual(offer.company_name, 'Ренессанс')
        self.assertEqual(offer.insurance_year, 2)
        self.assertEqual(offer.installment_variant_1, False)
        self.assertEqual(offer.payments_per_year_variant_1, 1)  # Должно автоматически стать 1
