...
**Франшиза**
- Часть ущерба, которую берет на себя страхователь
- Снижает стоимость страхования
- Может быть условной или безусловной

**Рассрочка**
- Возможность оплаты страховой премии частями
- Обычно 2-4 платежа в течение года
- Может включать дополнительные комиссии

**Автозапуск**
- Система дистанционного запуска двигателя
- Повышает риск угона, влияет на стоимость КАСКО
- Обязательно указывается в заявке

**КАСКО категории C/E**
- Специальная категория для коммерческого транспорта
- Применяется для грузовых автомобилей, автобусов
- Имеет особые тарифы и условия
...
Подробное описание всех статусов заявок см. в разделе [Просмотр списка заявок](#просмотр-списка-заявок).
