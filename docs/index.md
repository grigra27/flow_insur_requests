...
| **Рассрочка** | F34 + D32/33/34/35 | Требование рассрочки платежа: если F34 пустая И D32/33/34/35 пустая → есть рассрочка; если F34 не пустая ИЛИ D32/33/34/35 не пустая → НЕТ рассрочки (для ИП: F35 + D33/34/35/36) |
