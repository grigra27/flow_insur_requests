...
# Версия логики разбора — пишется на каждую V2-заявку (additional_data.parser_v2.version)
# и нужна, чтобы на странице «Правки распознавания» видеть, стало ли меньше ручных
