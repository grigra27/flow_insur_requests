...
def _build_common_request_kwargs(request_fields, additional_data, user):
    ...
    return {
        ...
        'transportation_departure': request_fields.get('transportation_departure') or '',
        'transportation_destination': request_fields.get('transportation_destination') or '',
        'transportation_days': request_fields.get('transportation_days'),
