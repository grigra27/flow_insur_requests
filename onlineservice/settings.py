...
# Default False — fail-safe if .env is missing or DEBUG is unset.
# For local development set DEBUG=True explicitly in .env.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'onlineservice.context_processors.navigation_context',
            ],
        },
    },
]
