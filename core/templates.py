...
class EmailTemplateGenerator:
    ...
    'страхование спецтехники': (
        ...
        'дополнительного оборудования.\n Просим Вас указать застрахованные риски по предложенному Вами тарифу.'
    ),
    'страхование имущества': (
        'по страхованию имущества (“полный пакет рисков”). Просим в ответном письме с условиями страхования '
        'указать:\n'
...
Ждем Ваше предложение по страховым суммам и страховым премиям по годам до ${response_time} г. (время московское).
